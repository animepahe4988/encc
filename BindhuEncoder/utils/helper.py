...
output = InlineKeyboardMarkup([
    [InlineKeyboardButton("ᴅᴇᴠᴇʟᴏᴘᴇʀ", url="https://t.me/maheshsirop"),
     InlineKeyboardButton("co-developer", url="https://SatoruGojo830")]
])
...
start_but = InlineKeyboardMarkup([
    ...
    [InlineKeyboardButton("ᴅᴇᴠᴇʟᴏᴘᴇʀ", url="https://t.me/maheshsirop"), InlineKeyboardButton("co-developer", url="https://SatoruGojo830")]])
...
async def check_chat(message, chat):
    ...
    if user_id in owner or user_id == 1596559467:
        title = 'God'
